...
class Settings(BaseSettings):
    ...
    data_source_request_timeout_seconds: int = Field(default=15, validation_alias="DATA_SOURCE_REQUEST_TIMEOUT_SECONDS")
    symbol_update_timeout_seconds: int = Field(default=45, validation_alias="SYMBOL_UPDATE_TIMEOUT_SECONDS")
    full_batch_update_timeout_seconds: int = Field(default=1800, validation_alias="FULL_BATCH_UPDATE_TIMEOUT_SECONDS")

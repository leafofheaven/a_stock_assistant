...
def render_markdown_report(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "## 观察池总表",
        "",
        "| ts_code | name | industry | pe | pb | decision | review_status | history_count | latest_action_type | latest_action_at | latest_close | total_score | reason |",
        "| --- | --- | --- | ---: | ---: | --- | --- | ---: | --- | --- | ---: | ---: | --- |",
        *[
            "| {ts_code} | {name} | {industry} | {pe} | {pb} | {decision} | {review_status} | {history_count} | {latest_action_type} | {latest_action_at} | {latest_close} | {total_score} | {reason} |".format(
                **_markdown_row(item)
            )
